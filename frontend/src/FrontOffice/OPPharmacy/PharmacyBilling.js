...
function PharmacyBilling() {
  ...
  useEffect(() => {
    ...
    if (Selected_Patient_Pharmacy && Selected_Patient_Pharmacy?.type) {
      axios
        .get(
          `${UrlLink}DrugAdminstrations/${Selected_Patient_Pharmacy?.type === "IP"
            ? "get_prescription_forIP"
            : "get_prescription"
          }?PatientID=${Billing_PatientID}&VisitID=${Selected_Patient_Pharmacy?.VisitID
          }`
        )
        .then((response) => {
        ...
        if (printdata) {
          ...
          pdf.html(printdata, {
            ...
            callback: () => {
              ...
              if (Selected_Patient_Pharmacy.type == 'IP') {
                // Post the data using axios
                axios
                  .post(
                    `${UrlLink}DrugAdminstrations/IP_Pharmacy_Billing_link`,
                  ...
                  .then((res) => {
                    console.log("Post IP response:", res);
                    setPostInvoice(res.data.InvoiceNo);
                    setIsPrintButtonVisible(true);
                    navigate('/Home/IPPharmacyBillingList')
                  })
                  .catch((err) => {
              ...
              else if (Selected_Patient_Pharmacy.type == 'OP') {
                // Post the data using axios
                axios
                  .post(
                    `${UrlLink}DrugAdminstrations/OP_Pharmacy_Billing_link`,
                    formData, // Send the FormData directly
                    {
                      headers: { "Content-Type": "multipart/form-data" },
                    }
...
<div className="Main_container_app">
        <div className="new-patient-registration-form">
          <div className="QuickStock_container_header">
            <h3>
              <ShoppingCartIcon />
              {Selected_Patient_Pharmacy && Selected_Patient_Pharmacy.type === "IP"
                ? "IP Pharmacy Billing"
                : "OP Pharmacy Billing"}
            </h3>
          </div>
                ...
                <div className="RegisFormcon">
                  ...
                  <div className="added_regisFrm1">
                    ...
                    <input
                      ...
                      name="PatientID"
                      readOnly={Selected_Patient_Pharmacy.PatientID}
                    />
                  </div>
                  ...
                  <div className="added_regisFrm1">
                    ...
                    <input
                      ...
                      name="Patient_Name"
                      readOnly={Selected_Patient_Pharmacy.Patient_Name}
                    />
                  </div>
                  ...
                  <div className="added_regisFrm1">
                    ...
                    <input
                      name="doctor_name"
                      readOnly={Selected_Patient_Pharmacy.Doctor_name}
