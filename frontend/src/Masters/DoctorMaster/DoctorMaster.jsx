  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setClassificationData(ClassificationResponse.data);
          ...
          {Object.keys(DoctorPersonalForm)
            .filter((p) =>
              DoctorPersonalForm.MaritalStatus === "Married"
                ? p !== "DoctorID"
                : !["AnniversaryDate", "DoctorID", "SpouseName"].includes(p)
            )
            .map((field, indx) => (
                ...
                {[
                  ...
                  >
                    ...
                    {field === "Classification" &&
                      ClassificationData.filter((p) => p.Status === "Active").map(
                        (p, index) => (
                          <option key={index} value={p.id}>
                            {p.Classification}
                          </option>
                    ...
                    {field === "Role" &&
                      RoleData.filter((p) => p.Status === "Active").map(
                        (p, index) => (
                          <option key={index} value={p.id}>
                            {p.Role}
                          </option>
