...
const SampleCollectionQueueList = () => {
    ...
    const [searchOPParams, setsearchOPParams] = useState({ query: '', status: 'Pending', Billing_Status: "Completed",Service_Status: "Pending",queue_type: "samplecollection" });
    ...
    const handleeditOPPatientRegister = (params) => {
        ...
        // if (params.Service_Status === "Pending") {
            // dispatchvalue({ type: 'LabWorkbenchNavigation', value: { params } });
            // navigate('/Home/LabRequest');

            dispatchvalue({ type: 'SampleCollectionqueueData', value: params })

            navigate('/Home/Lab')
            dispatchvalue({ type: 'HrFolder', value:'SampleCollection'});
    ...
    return (
        <div className="Main_container_app">
            <h3>Sample Collection Queue List</h3>
...
export default SampleCollectionQueueList;
