...
const AssetSubCategoryManagement = () => {
    ...
    const AssetSubCategoriesColumn = [
        { key: 'id', name: 'SubCategory ID', frozen: true },
    ...
    return (
        <div className="Main_container_app">
            ...
            {categories.map(category => (
                <div key={category.id} hidden={activeCategory !== category.id} style={{width:"100%"}}>
                    <ReactGrid columns={AssetSubCategoriesColumn} RowData={subCategories[category.id] || []} />
                </div>
            ))}
        </div>
    );
