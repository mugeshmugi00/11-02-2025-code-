...
const Vitals = () => {
  ...
  const HandleOnChange = (event) => {
    ...
    // Check if the field is NOT "BMI" and enforce 3-digit rule
    if (name !== "BMI" && !/^\d{1,3}$/.test(value) && value !== "") {
      dispatch({ type: "toast", value: { message: "Only numbers up to 3 digits are allowed.", type: "warn" } });
      return;
    }
