              ...
              <tr>
                <td style={{ width: "200px" }}>
                  ...
                  >
                    ...
                    >
                      <td style={{height:'28px'}}>Shoulder</td>
                    </div>
              ...
              <tr>
                <td style={{ width: "200px" }}>
                  ...
                  >
                    ...
                    >
                      <td style={{height:'28px'}}>Wrist</td>
                      <td style={{height:'28px'}}>Hand</td>
                    </div>
