...
const Op_otrequest = () => {
    ...
    console.log(IP_DoctorWorkbenchNavigation.PatientId, "IP_DoctorWorkbenchNavigation");
    ...
    useEffect(() => {
      ...
      if(params){
        ...
        setFormData((prev)=>({
          ...
          opregistrationnid : params?.RegistrationId,
...
// }, [UrlLink,load]);
  ...
  .catch((err) => console.log(err));
    ...
    // navigate("/Home/OT_Queue_List123");
