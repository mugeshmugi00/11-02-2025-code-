...
useEffect(()=>{
  ...
  return (
    <div className="Main_container_app">
      ...
      {/* Custom Popup */}
      {open && (
        <div className="custom-popup-098">
          <div className="popup-container-prem">
            <h3>Update Status</h3>

            <br />
            <div className="popup-content-prem">
              <div className="popup-field-prem">
                <label>Status<span>:</span></label>
                <select
                  value={status}
                  onChange={(e) => setStatus(e.target.value)}
                  className="popup-select-prem"
                >
            ...
            <button onClick={handleClose}             className="RegisterForm_1_btns jwedu6_99"
            >
                Cancel
              </button>
              <button onClick={handleSubmit}             className="RegisterForm_1_btns jwedu6_99"
              >
                Submit
              </button>
            </div>
