  ...
  const handleClear = () => {
    ...
    return (
        <>
                ...
                {
                    Object.keys(BloodTransfusedRecord).map((p, index) =>   p !== "Remarks" && ((
    ...
    <textarea
      id="Remarks"
      name="Remarks"
      value={BloodTransfusedRecord.Remarks}
      onChange={(e) => {
        HandleOnChange(e); // Handle change
        adjustHeight(e); // Adjust height when the value changes
      }}
      readOnly={IsViewMode}
