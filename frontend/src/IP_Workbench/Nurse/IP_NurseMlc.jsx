...
//               <div className={`RegisForm_${type === "textarea" ? "text" : "1"}`} key={name}>
...
//             <div className="RegisForm_text radio_1">
//               <label>Fir Status<span>:</span></label>
//               {["Yes", "No"].map((option) => (
//                 <span key={option}>
//                   <input
...
//                     name="Investigation"
//                     value={option}
//                     checked={Mlc.Investigation === option}
//                     onChange={handleMlcChange}
//                     readOnly={IsViewMode}
//                     disabled={IsViewMode}
//                   />
