    ...
    <>
         <div className="Main_container_app">
            ...
            <div className="OtMangementForm_1 djkwked675 dedwe">
                <label className="jewj33j">Date<span>:</span></label>
                <input
                type="date"
            ...
            <div className="OtMangementForm_1 djkwked675 dedwe">
                <label className="jewj33j">Time<span>:</span></label>
                <input
                type="time"
            ...
            <div
                className="wdqqwqxxz ergtregter_v"
            ...
            <div className="wdqqwqxxz ergtregter_v">
                <label>
                <p
                    style={{
                    marginRight: "10px",
