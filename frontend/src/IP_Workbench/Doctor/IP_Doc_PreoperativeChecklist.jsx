...
const IP_Doc_PreoperativeChecklist = () => {
    ...
    const handleCheckboxChange = (name, option) => {
      ...
      const handleTextareaChange = (name, value,e) => {
        setSelectedOption((prevData) => ({
          ...prevData,
          [name]: value,
        }));
        ...
        if (e) {
          adjustHeight(e); // Pass the event to adjustHeight
      }
        ...
        {name === "VoidedAmount" || name === "PulseRate" || name === "RespRate"? (
          <div className="EWFERYU7KUILP7">
            <textarea
              ...
              readOnly={IsViewMode}
              onChange={(e) => handleTextareaChange(name, e.target.value,e)}
              disabled={IsViewMode}
          ...
          <div className="OtMangementForm_1_checkbox">
            ...
            <div className="EWFERYU7KUILP7">
              ...
              <textarea
                ...
                readOnly={IsViewMode}
                onChange={(e) => handleTextareaChange(`${name}Remarks`, e.target.value,e)}
              />
            </div>
          </div>
        )}
        ...
        <div className="Main_container_app">
                ...
                <div className="Print_ot_all_div_rfve">
                    ...
                    <div className="OtMangementForm_1_checkbox">
                        ...
                        readOnly={IsViewMode}
                        onChange={(e) =>
                            handleTextareaChange("SpecialDrug", e.target.value,e)
                        }
                        ></textarea>
                    </div>
                    </div>
