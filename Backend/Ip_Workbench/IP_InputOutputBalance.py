    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for idx, intake in enumerate(intake_details, start=1):
                ...
                ip_registration = intake.Ip_Registration_Id
                casuality_registration = intake.Casuality_Registration_Id
            ...
            for idx, Output in enumerate(Outut_details, start=1):
                ip_registration = Output.Ip_Registration_Id
                casuality_registration = Output.Casuality_Registration_Id
