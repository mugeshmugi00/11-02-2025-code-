...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Emg_to_IP_Convertion_Table',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('DischargePerson', models.CharField(blank=True, max_length=30, null=True)),
                ('Reason', models.TextField()),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('EmgRegistration_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Frontoffice.patient_emergency_registration_detials')),
            ],
            options={
