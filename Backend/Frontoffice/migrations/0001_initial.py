    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Net_Paid_Amount', models.DecimalField(decimal_places=2, max_digits=10)),
        ...
        migrations.CreateModel(
            name='Multiple_Payment_Radiology_Table_Detials',
            fields=[
                ...
                ('Card_No', models.CharField(default=0, max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Payment_Type', models.CharField(max_length=70)),
                ('Cart_Type', models.CharField(max_length=30)),
                ('Card_No', models.CharField(blank=True, default=0, max_length=4, null=True)),
                ('TransactionId', models.CharField(blank=True, default='', max_length=50, null=True)),
                ('upiid', models.CharField(blank=True, default='', max_length=50, null=True)),
                ('Cheque_No', models.CharField(max_length=20)),
                ('Bank_Name', models.CharField(max_length=50)),
                ('Transaction_Amount', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('AdditionalAmount', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('Amount', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Per_hr_unit_cost', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BookingType', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PermanentAddressSameAsAbove', models.CharField(blank=True, max_length=20, null=True)),
                ('PermanentdoorNo', models.CharField(blank=True, max_length=20, null=True)),
                ('PermanentStreet', models.CharField(blank=True, max_length=30, null=True)),
                ('PermanentArea', models.CharField(blank=True, max_length=30, null=True)),
                ('PermanentCity', models.CharField(blank=True, max_length=30, null=True)),
                ('PermanentDistrict', models.CharField(blank=True, max_length=50, null=True)),
                ('PermanentState', models.CharField(blank=True, max_length=30, null=True)),
                ('PermanentCountry', models.CharField(blank=True, max_length=30, null=True)),
                ('PermanentPincode', models.CharField(blank=True, max_length=20, null=True)),
                ('created_by', models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            name='Radiology_Billing_Items_Table_Detials',
            fields=[
                ('Items_Id', models.AutoField(primary_key=True, serialize=False)),
                ('Service_Type', models.CharField(max_length=100)),
                ('Service_Code', models.CharField(max_length=30, null=True)),
        ...
        migrations.CreateModel(
            name='Radiology_Billing_Table_Detials',
            fields=[
                ('Billing_Invoice_No', models.CharField(max_length=30, primary_key=True, serialize=False)),
                ('Billing_Date', models.DateField()),
                ('Billing_Type', models.CharField(blank=True, max_length=150, null=True)),
                ('Select_Discount', models.CharField(max_length=50)),
                ('Discount_Type', models.CharField(max_length=30)),
                ('Discount_Value', models.DecimalField(decimal_places=2, max_digits=10)),
                ('Discount_Amount', models.DecimalField(decimal_places=2, max_digits=10)),
        ...
        migrations.CreateModel(
            name='Services_SubCat_Requests_Details',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='Theatre_Booking_Request_Details',
            fields=[
                ...
                ('UHIDNO', models.CharField(blank=True, max_length=255, null=True)),
